...
expName = 'orientation_discriminationtask'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Ishitaa Nadar\\OneDrive\\Desktop\\psychopy\\orientation_discriminationtask_lastrun.py',
