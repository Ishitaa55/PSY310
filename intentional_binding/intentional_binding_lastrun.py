...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Ishitaa Nadar\\OneDrive\\Desktop\\psychopy\\intentional_binding\\intentional_binding_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=5.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/Ishitaa Nadar/OneDrive/Documents/ib_cons.xlsx'),
